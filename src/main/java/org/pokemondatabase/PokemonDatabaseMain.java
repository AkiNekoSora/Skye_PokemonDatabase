 ...
 * Pokémon to the CLI, update a Pokémon using the CLI, compare the weight and height of two
...
public class PokemonDatabaseMain {
    ...
    public static void main(String[] args) {
        PokemonDatabaseMenu pokemonDatabaseMenu = new PokemonDatabaseMenu();
        List<Pokemon> pokemonStorage = new ArrayList<>();

        pokemonDatabaseMenu.pokemonDatabaseMenu(pokemonStorage);
    }
}