...
public class PokemonManager {
    ...
    public int addPokedexNumber(List<Pokemon> pokemonStorage) {
        ...
        while (!uniquePokedexNum) {
            ...
            uniquePokedexNum = validateUniquePokedexNumber(pokedexNumber,
                    pokemonStorage);
        }
     ...
     */
    public boolean validateUniquePokedexNumber(int pokedexNumber, List<Pokemon> pokemonStorage) {
        for (Pokemon pokemon : pokemonStorage) {
            if (pokemon.getPokedexNumber() == pokedexNumber) {
                System.out.println(userInputHelper.errorMessageColors("Pokédex number " + pokemon.getPokedexNumber() +
                        " already exists in the database as " + pokemon.getPokemonName() + "."));
                return false;
            }
        }
        return true;
    ...
    public Pokemon getPokemon(List<Pokemon> pokemonStorage, String[] variables, int lineCounter) {
        ...
        if (!(validateUniquePokedexNumber(pokedexNumber, pokemonStorage))) {
